...
<option value="Escrita Contabilidade">Escrita Contabilidade</option>
...
<option value="Franks(testes)">Franks(testes)</option>
...
<option value="Onboardings Tripulantes">Onboardings Tripulantes</option>
...
<option value="Pousada Aloha">Pousada Alhoa</option>
...
<option value="Weef">Weef</option>
            ...
            <h3>DADOS POR SERVIÇOS ATIVOS</h3>
            ...
            <label for="web_protection_filtradas_bloqueadas">Web Protection - Solicitações filtradas bloqueadas:</label>
            <input type="number" id="web_protection_filtradas_bloqueadas" name="web_protection_filtradas_bloqueadas" required><br>

            <label for="web_protection_mal_intencionadas_bloqueadas">Web Protection - Solicitações mal-intencionadas bloqueadas:</label>
            ...
            <h3>DADOS DO PORTAL DE CHAMADOS</h3>

            <label for="num_chamados_abertos">Nº de Chamados Abertos:</label>
            <input type="number" id="num_chamados_abertos" name="num_chamados_abertos" required><br>

            <label for="num_chamados_fechados">Nº de Chamados Fechados:</label>
    ...
    if(isset($_POST['submit'])) {
        ...
        $usuario = "mariomokfa"; // Nome de usuário do MySQL
        $senha = "M4ri0Br0s"; // Senha do MySQL
